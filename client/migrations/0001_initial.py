    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_status', models.IntegerField(choices=[(None, 'Please select'), (0, 'Canvass'), (1, 'Closed'), (2, 'Education'), (3, 'Employed'), (4, 'Profile'), (5, 'Waiting List'), (6, 'Work Experience')], default=None)),
