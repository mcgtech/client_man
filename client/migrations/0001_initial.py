    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employment_status', models.IntegerField(choices=[(None, 'Please select'), (0, 'Economically Inactive'), (1, 'Employed (including self-employed)'), (2, 'Long Term Employed'), (3, 'NEET Inactive'), (4, 'Unemployed')], default=None)),
