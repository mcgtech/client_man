...
class EmailTempTable(tables.Table):
    ...
    class Meta:
        ...
        fields = ('id', 'template_identifier', 'subject', 'from_address', 'to_address', 'cc_address', 'bcc_address', 'plain_body', 'html_body')
        attrs = {"class": "paleblue table table-striped table-hover table-bordered"}
        sequence = ('id', 'template_identifier', 'subject', 'from_address', 'to_address', 'cc_address', 'bcc_address', 'plain_body', 'html_body')