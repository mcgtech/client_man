...
class EmailTempTable(tables.Table):
    ...
    class Meta:
        ...
        fields = ('id', 'template_identifier', 'subject', 'from_address', 'to_addresses', 'cc_addresses', 'bcc_addresses', 'plain_body', 'html_body', 'modified_by', 'modified_on')
        attrs = {"class": "paleblue table table-striped table-hover table-bordered"}
        sequence = ('id', 'template_identifier', 'subject', 'from_address', 'to_addresses', 'cc_addresses', 'bcc_addresses', 'plain_body', 'html_body', 'modified_by', 'modified_on')