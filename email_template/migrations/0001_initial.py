    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_identifier', models.IntegerField(choices=[(None, 'Please select'), (0, 'Contract accept'), (1, 'Contract revoke'), (2, 'Contract approve'), (3, 'Contract reject'), (4, 'Contract undo')], default=None, unique=True)),
