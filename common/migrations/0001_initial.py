# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-01 07:56
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.IntegerField(choices=[(None, 'Please select'), (0, 'Email'), (1, 'Report')], default=None)),
                ('title', models.IntegerField(choices=[(None, 'Please select'), (0, 'Contract accept'), (1, 'Contract revoke'), (2, 'Contract approve'), (3, 'Contract reject')], default=None)),
